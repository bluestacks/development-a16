...
describe('FlattenChildren', () => {
  ...
  it('flattens children of nested tree', () => {
    ...
    let prevChild = UiTreeNodeUtils.makeUiHierarchyNode({
      id: 0,
      name: 'child',
    });
  ...
  it('flattens children in expected order for multiple root children', () => {
    ...
    const firstChild = UiTreeNodeUtils.makeUiHierarchyNode({
      id: 0,
      name: 'child',
    });
    ...
    const secondChild = UiTreeNodeUtils.makeUiHierarchyNode({
      id: 5,
      name: 'child',
    });
